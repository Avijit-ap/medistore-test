...
export default function Example() {
  ...
  return (
    <>
      <header className="bg-gradient-to-tr from-teal-500 to-teal-300 text-white flex flex-row justify-around">
        <div className="flex flex-row justify-start">
          ...
          <Typography
            as="li"
            className="pl-9 flex flex-row gap-2 py-3 text-sm"
          >
            <a href="mailto:medicalsuport@gmail.com" className="flex flex-row gap-2">
      ...
      <Navbar className="sticky border-none shadow-xl drop-shadow-xl top-0 z-10 h-max max-w-full bg-[#e2f4faee] rounded-none py-3 px-5 lg:px-8 ">
        ...
        <Collapse open={openNav} >
          {navList}
          <Button variant="gradient" color="teal" size="sm" className="py-3 mb-2">
            <span>LogIn Now</span>
          </Button>
        </Collapse>
      </Navbar>
